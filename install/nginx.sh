...
DESC="nginx daemon"
NAME=nginx
DAEMON=/usr/local/nginx-1.4.4/sbin/$NAME
CONFIGFILE=/usr/local/nginx-1.4.4/conf/$NAME.conf
PIDFILE=/usr/local/nginx-1.4.4/logs/$NAME.pid
...
echo "Install nginx 1.4.4 successfully."